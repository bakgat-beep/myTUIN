...
class CreateGrowingSpaceTest {
    ...
    private val createGrowingSpace = CreateGrowingSpace(
    ...
    @Test
    fun invoke_returns_the_generated_id() = runBlocking {
        val id = createGrowingSpace(minimalInput())
        assertEquals("growingspace_test_0001", id)
    }

    @Test
    fun invoke_persists_a_space_with_assigned_id_status_and_timestamps() = runBlocking {
    ...
    @Test
    fun invoke_defaults_all_optional_fields_to_null() = runBlocking {
        createGrowingSpace(minimalInput())
    ...
    @Test
    fun invoke_preserves_dimensions() = runBlocking {
        createGrowingSpace(
            minimalInput().copy(
                lengthMetres = 3.0,
                widthMetres = 1.2,
    ...
    @Test
    fun invoke_preserves_polygon_geometry() = runBlocking {
    ...
    private fun minimalInput(): NewGrowingSpace = NewGrowingSpace(
