...
class UpdateGardenLocationTest {
    ...
    private val useCase = UpdateGardenLocation(
    ...
    @Test
    fun invoke_forwards_location_fields_to_repository() = runBlocking {
    ...
    @Test
    fun invoke_supplies_updatedAt_from_clock() = runBlocking {
    ...
    @Test
    fun invoke_applies_all_fields_to_the_stored_garden() = runBlocking {
        useCase(
            existingId,
            NewGardenLocation(
                countryCode = "NZ",
    ...
    @Test
    fun invoke_with_all_nulls_clears_existing_location() = runBlocking {
        useCase(
            existingId,
            NewGardenLocation(
                countryCode = "NZ",
    ...
    @Test
    fun invoke_does_not_change_id_name_description_status_or_createdAt() = runBlocking {
        useCase(
            existingId,
            NewGardenLocation(
                countryCode = "NZ",
