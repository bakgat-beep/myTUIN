...
class GardenRepositoryFlowTest {
    ...
    @Test
    fun observeGardens_emits_empty_list_initially() = runTest {
    ...
    @Test
    fun observeGardens_emits_after_insert() = runTest {
        repository.observeGardens().test {
    ...
    @Test
    fun observeGardens_emits_after_each_insert_in_order() = runTest {
        repository.observeGardens().test {
            assertEquals(0, awaitItem().size)
    ...
    private fun sampleGarden(id: String, name: String): Garden = Garden(
        id = id,
        name = name,
        description = null,
        countryCode = null,
