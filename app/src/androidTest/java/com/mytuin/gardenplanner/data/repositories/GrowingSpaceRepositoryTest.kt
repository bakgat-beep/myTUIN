...
class GrowingSpaceRepositoryTest {
    ...
    @Test
    fun getGrowingSpace_returns_null_when_no_space_exists() = runBlocking {
    ...
    @Test
    fun insert_requires_existing_garden() = runBlocking {
        val orphan = sampleSpace().copy(
    ...
    @Test
    fun observeGrowingSpacesInGarden_scopes_to_garden_and_orders_by_name() = runBlocking {
        ...
        repository.insert(sampleSpace().copy(
    ...
    @Test
    fun point_geometry_round_trips_through_geojson() = runBlocking {
    ...
    @Test
    fun line_string_geometry_round_trips_through_geojson() = runBlocking {
    ...
    @Test
    fun polygon_geometry_round_trips_through_geojson() = runBlocking {
        val geometry = Geometry.Polygon(
            listOf(
                Coordinate(0.0, 0.0),
                Coordinate(3.0, 0.0),
                Coordinate(3.0, 1.0),
    ...
    @Test
    fun null_geometry_round_trips_as_null() = runBlocking {
    ...
    @Test
    fun geometry_type_is_stored_as_canonical_id_not_geojson_name() = runBlocking {
        repository.insert(
            sampleSpace().copy(
        ...
        db.openHelper.readableDatabase
            ...
            .use { cursor ->
                ...
                assertTrue("GeoJSON type name expected in data",
                    json.contains("\"type\":\"Polygon\""))
            }
    }

    @Test
    fun space_type_is_stored_as_canonical_id() = runBlocking {
    ...
    private fun sampleSpace(): GrowingSpace = GrowingSpace(
