...
class PlantRepositoryTest {
    ...
    @Test
    fun getPlant_returns_null_when_no_plant_exists() = runBlocking {
        assertNull(repository.getPlant("plant_does_not_exist"))
    }

    @Test
    fun getPlant_maps_all_fields_from_entity_to_domain() = runBlocking {
    ...
    @Test
    fun getPlant_preserves_null_lifecycle_distinct_from_unknown() = runBlocking {
        val entity = samplePlant().copy(
    ...
    @Test
    fun observePlants_emits_inserted_rows_in_name_order() = runBlocking {
        val beta = samplePlant().copy(
            id = "plant_00000000-0000-0000-0000-0000000000bb",
            canonical_name = "Beta plant",
        )
        val alpha = samplePlant().copy(
            id = "plant_00000000-0000-0000-0000-0000000000aa",
    ...
    @Test
    fun observeAliasesForPlant_returns_only_that_plants_aliases() = runBlocking {
        val plantA = samplePlant()
        val plantB = samplePlant().copy(
            id = "plant_00000000-0000-0000-0000-0000000000bb",
    ...
    @Test
    fun observeCultivarsForPlant_returns_only_that_plants_cultivars() = runBlocking {
        val plantA = samplePlant()
        val plantB = samplePlant().copy(
            id = "plant_00000000-0000-0000-0000-0000000000bb",
            canonical_name = "Other plant",
        ...
        val cultivarA = sampleCultivar(
            id = "cultivar_00000000-0000-0000-0000-0000000000a1",
            plantId = plantA.id,
            name = "Cultivar for A",
        )
        val cultivarB = sampleCultivar(
    ...
    @Test
    fun lifecycle_enum_id_round_trips_through_domain_layer() = runBlocking {
    ...
    @Test
    fun alias_type_enum_id_round_trips_through_domain_layer() = runBlocking {
    ...
    ): PlantAliasEntity = PlantAliasEntity(
        id = id,
        plant_id = plantId,
        alias = alias,
