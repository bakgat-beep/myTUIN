...
class GardenRepositoryTest {
    ...
    @Test
    fun getGarden_returns_null_when_no_garden_exists() =
        runBlocking {
    ...
    @Test
    fun insert_then_get_preserves_unknown_hemisphere() =
        runBlocking {
            val garden =
                sampleGarden().copy(
    ...
    @Test
    fun insert_then_get_preserves_null_location_fields() =
        runBlocking {
            val garden =
                sampleGarden().copy(
    ...
    @Test
    fun observeGardens_emits_inserted_rows_in_name_order() =
        runBlocking {
            repository.insert(
                sampleGarden().copy(
                    id = "garden_00000000-0000-0000-0000-0000000000bb",
    ...
    @Test
    fun insert_allows_duplicate_names() =
        runBlocking {
    ...
    @Test
    fun updateLocation_replaces_all_seven_location_fields() =
        runBlocking {
            val garden = sampleGarden()
            repository.insert(garden)
    ...
    @Test
    fun updateLocation_leaves_id_name_description_status_and_createdAt_alone() =
        runBlocking {
            val garden = sampleGarden()
            repository.insert(garden)
    ...
    @Test
    fun updateLocation_with_nulls_clears_existing_values() =
        runBlocking {
            val garden = sampleGarden()
            repository.insert(garden)
    ...
    @Test
    fun updateLocation_throws_NotFoundError_when_garden_does_not_exist() =
        runBlocking {
            try {
                repository.updateLocation(
    ...
    private fun sampleGarden(): Garden =
        Garden(
