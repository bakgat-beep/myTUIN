...
class GrowingSpaceHistoryRepositoryImpl
    @Inject
    constructor(
        ...
        override fun observeHistoryForSpace(growingSpaceId: String): Flow<List<GrowingSpaceHistory>> =
            growingSpaceHistoryDao
                .observeForSpace(growingSpaceId)
        ...
        override suspend fun getHistoryAsOf(
            ...
            atMillis: Long,
        ): GrowingSpaceHistory? = growingSpaceHistoryDao.getAsOf(growingSpaceId, atMillis)?.toDomain()
    }
