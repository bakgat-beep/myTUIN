...
class GardenPreferenceRepositoryImpl @Inject constructor(
    ...
    override fun observePreferences(gardenId: String): Flow<List<GardenPreference>> =
        gardenPreferenceDao.observePreferences(gardenId)
    ...
    override suspend fun getPreference(
        ...
        gardenPreferenceDao.getPreference(gardenId, key)?.toDomain()
    ...
    override suspend fun clearPreference(gardenId: String, key: GardenPreferenceKey) {
    ...
    override fun observePlantPreferences(
        ...
        gardenPreferenceDao.observePlantPreferences(gardenId, kind)
            .map { rows -> rows.map { it.toDomain() } }
    ...
    override suspend fun getPlantPreferences(
        ...
        gardenPreferenceDao.getPlantPreferences(gardenId, kind)
            .map { it.toDomain() }
